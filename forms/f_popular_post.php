      ...
      <div class="row">
       <div class="col-md-12">
          <div class="box box-info">
            ...
            <!-- form start -->
            <form id="FDem" action="main.php?m=popular_post" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
					...
					<p class="help-block">Скопируйте URL групп популярные посты которых нужно собрать. Каждую группу указывайте с новой строки.</p>
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-4 control-label">Искать посты с даты:</label>
                  <div class="col-sm-8">
					...
					<p class="help-block">Укажите с какой даты собирать посты группы.</p>
                  </div>
                </div>
              </div><!-- /.box-body -->
