      ...
      <div class="row">
       <div class="col-md-12">
          <div class="box box-info">
            ...
            <!-- form start -->
            <form id="FDem" action="main.php?m=aktivnost" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
					...
					<p class="help-block">Скопируйте URL групп, подписчиков, которые проявили активности, нужно собрать. Каждую группу указывайте с новой строки. (Макс. 50 групп)</p>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
					...
					<p class="help-block">Укажите с какой даты собирать подписчиков, проявивших активности.</p>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
					...
					<p class="help-block">Отметьте подписчиков проявивших какие активности нужно собирать.</p>
                  </div>
                </div>
              </div><!-- /.box-body -->
